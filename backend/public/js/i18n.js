...
(function(){
  ...
  var LOCALES = {
    es: {
      ...
      repair: { title:'Re-emparejar Smart TV', device:'Dispositivo', sub:'El TV perderá su sesión actual y necesitará un nuevo código.', inst_1:'Enciende el TV.', inst_2:'Abre <span style="background:#111;color:#c9a4ff;padding:2px 6px;border-radius:4px;font-family:monospace;font-size:11px;">cms.sonoro.com.co/pair</span> en el TV.', inst_3:'Copia abajo el nuevo código que aparece.', confirm:'Re-emparejar' },
    ...
    en: {
      ...
      repair: { title:'Re-pair Smart TV', device:'Device', sub:'The TV will lose its current session and will need a new code.', inst_1:'Turn the TV on.', inst_2:'Open <span style="background:#111;color:#c9a4ff;padding:2px 6px;border-radius:4px;font-family:monospace;font-size:11px;">cms.sonoro.com.co/pair</span> on the TV.', inst_3:'Copy the new code shown below.', confirm:'Re-pair' },
    ...
    'pt-BR': {
      ...
      repair: { title:'Re-parear Smart TV', device:'Dispositivo', sub:'O TV perderá sua sessão atual e precisará de um novo código.', inst_1:'Ligue o TV.', inst_2:'Abra <span style="background:#111;color:#c9a4ff;padding:2px 6px;border-radius:4px;font-family:monospace;font-size:11px;">cms.sonoro.com.co/pair</span> no TV.', inst_3:'Copie abaixo o novo código exibido.', confirm:'Re-parear' },
